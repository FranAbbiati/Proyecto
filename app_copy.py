...
def crear_base_datos():
    ...
    # Si la base vieja tiene "contrasena",
    # la cambiamos al nombre actual "contrasena".
    if (
        "contraseña" in nombres_columnas
        and "contrasena" not in nombres_columnas
    ):
